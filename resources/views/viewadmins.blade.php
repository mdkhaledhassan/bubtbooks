...
<div id="all">
      <div id="content">
        <div class="container">
            ...
            <div class="col-lg-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Admins</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
              ...
              <div class="box">
                  ...
                  <h3><p style="text-align:left;">
                        ...
                        <span style="float:right;">
                          <a href="#" class="btn btn-primary navbar-btn" data-toggle="modal" data-target="#addadmin-modal">Add Admin</a>
                        </span>
                    </p>
                  </h3>
                <hr>
                    ...
                    <div id="addadmin-modal" class="modal fade">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> Add Admin</button>
                  </div>
                </form>
                                </div>
                            </div>
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <div id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="Delete Admin" aria-hidden="true" class="modal fade">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="text-center text-muted">Are you sure you want to trash admin?</p>

                <div class="navbar-buttons d-flex justify-content-end" align="center">


                  <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="/viewadmins" class="btn btn-primary navbar-btn" onclick="event.preventDefault();
                                                     document.getElementById('yes').submit();">Yes</a>
                                                     <form id="yes" action="{{ route('deleteadmin', ['id' => $alu->id]) }}" method="post">
          {{csrf_field()}}
        ...
        <div id="update-modal" tabindex="-1" role="dialog" aria-labelledby="Update Admin" aria-hidden="true" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Updating Admin</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
              </div>
              <div class="modal-body">
                <form action="{{ route('updateadmin', ['id' => $alu->id]) }}" method="post">
                        {{csrf_field()}}
                <input type="hidden" name="id" id="id" value="">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> Update Admin</button>
                  </div>
                </form>
                </div>
            </div>
              ...
              <div id="view-modal" tabindex="-1" role="dialog" aria-labelledby="View Admin Information" aria-hidden="true" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">View Admin Information</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
              </div>
              <div class="modal-body">
                <form>
