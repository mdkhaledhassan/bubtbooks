              ...
              <div class="box">
                  ...
                  <h3><p style="text-align:left;">
                        ...
                        <span style="float:right;">
                          <a data-toggle="collapse" id="searchus" href="#" class="btn navbar-btn btn-primary d-none d-lg-inline-block"><i class="fa fa-search"></i></a><a href="#" class="btn btn-primary navbar-btn" data-toggle="modal" data-target="#adduser-modal">Add User</a>
                        </span>
                    </p>
                  </h3>
                <hr>
                  ...
                  <br>
                    ...
                    <div id="adduser-modal" class="modal fade">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> Add User</button>
                  </div>
                </form>
                                </div>
                            </div>
