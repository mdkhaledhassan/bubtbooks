            ...
            <div class="col-lg-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Books</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
              ...
              <div class="box">
                  ...
                  <h3><p style="text-align:left;">
                        ...
                        <span style="float:right;">
                          <a data-toggle="collapse" id="searchbook" href="#" class="btn navbar-btn btn-primary d-none d-lg-inline-block"><i class="fa fa-search"></i></a><a href="#" class="btn btn-primary navbar-btn" data-toggle="modal" data-target="#addbook-modal">Add Book</a>
                        </span>
                    </p>
                  </h3>
                <hr>
                  ...
                  <div class="container">
                    <form action="{{ route('searchbooks') }}" role="search" class="ml-auto">
                ...
                <div id="addbook-modal" tabindex="-1" role="dialog" aria-labelledby="Add Book" aria-hidden="true" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Adding Book</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
              </div>
              <div class="modal-body">
                <form action="/viewbooks" method="post" enctype="multipart/form-data">
                        @csrf
                  <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select id="depname" type="text" class="form-control" name="depname">
                      ...
                      <option value="{{ $ald->depname }}">{{ ucfirst($ald->depname) }}</option>
                    @endforeach
                    </select>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select id="semname" type="text" class="form-control" name="semname"> 
                    </select>
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input id="buyingprice" type="text" class="form-control" name="buyingprice" value="{{ old('buyingprice') }}" required autocomplete="buyingprice" autofocus>
                  ...
                  <div class="form-group">
                    ...
                    <input id="sellingprice" type="text" class="form-control" name="sellingprice" value="{{ old('sellingprice') }}" required autocomplete="sellingprice" autofocus>
                  ...
                  <div class="form-group">
                    ...
                    <input id="totalquantity" type="text" class="form-control" name="totalquantity" value="{{ old('totalquantity') }}" required autocomplete="totalquantity" autofocus>
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> Add Book</button>
                  </div>
                </form>
                </div>
            </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th>{{$alb->depname}}</th>
                        <th>{{$alb->semname}}</th>
                        <td><a href="#" data-bookname="{{$alb->bookname}}" data-authorname="{{$alb->authorname}}" data-depname="{{$alb->depname}}" data-id="{{$alb->id}}" data-semname="{{$alb->semname}}" data-coursecode="{{$alb->coursecode}}" data-buyingprice="{{$alb->buyingprice}}" data-sellingprice="{{$alb->sellingprice}}" data-totalquantity="{{$alb->totalquantity}}" data-bookpic="{{$alb->bookpic}}" data-bookpdf="{{$alb->bookpdf}}" data-view_count="{{$alb->view_count}}" data-admin="{{$alb->admin}}" data-toggle="modal" data-target="#view-modal"><i class="fa fa-eye"></i></a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div id="post-content">
                  ...
                  <p><h5 align="left"><strong>Total View : </strong><input id="view_count" class="border-0" readonly></h5></p>
                  
                  <p><h5 align="left"><strong>Upload By : </strong><input id="admin" class="border-0" readonly></h5></p>
                </div>
              </form>
