                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="/vieworderbooks/{{$alo->id}}"><i class="fa fa-eye"></i></a>
                          ...
                          <a href="#" data-invoice="{{$alo->invoice}}" data-status="{{$alo->status}}" data-totalamount="{{$alo->totalamount}}" data-paymentamount="{{$alo->paymentamount}}" data-paymentmethod="{{$alo->paymentmethod}}" data-senderphonenumber="{{$alo->senderphonenumber}}" data-trxid="{{$alo->trxid}}" data-id="{{$alo->id}}" data-toggle="modal" data-target="#update1-modal"><i class="fa fa-pencil"></i></a>
                          @else
                          <a href="#" data-invoice="{{$alo->invoice}}" data-status="{{$alo->status}}" data-totalamount="{{$alo->totalamount}}" data-paymentamount="{{$alo->paymentamount}}" data-paymentmethod="{{$alo->paymentmethod}}" data-senderphonenumber="{{$alo->senderphonenumber}}" data-trxid="{{$alo->trxid}}" data-id="{{$alo->id}}" data-toggle="modal" data-target="#update-modal"><i class="fa fa-pencil"></i></a>
                          @endif
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{ route('updateorderstatus', ['id' => $alo->id]) }}" method="post">
                  ...
                  <hr>
                  <div id="post-content">
                  <p><h5 align="left"><strong>Book Invoice No : #</strong><input id="invoice" class="border-0" readonly></h5></p>
